    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-[#0a0a0a] pb-32">
      <header className="px-8 py-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter uppercase italic">Matches</h1>
      ...
      <div className="flex-grow px-6">
        {matches.length > 0 ? (
          <div className="grid grid-cols-2 gap-6">
            {matches.map((match) => (
              <motion.div
                ...
                className="relative aspect-[3/4] rounded-[2rem] overflow-hidden shadow-premium hover:shadow-2xl transition-all cursor-pointer group border border-gray-100 dark:border-white/5"
              >
                <img
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                  ...
                  <div className="flex items-center mt-1 space-x-1">
                    ...
                    <span className="text-[9px] font-bold uppercase tracking-widest text-gray-300">Online</span>
                  </div>
                </div>

                <div className="absolute top-3 right-3 p-2 bg-white/20 backdrop-blur-md rounded-xl opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-20">
            ...
            <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">No matches yet</h3>
